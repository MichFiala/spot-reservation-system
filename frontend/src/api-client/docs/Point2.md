...
------------ | ------------- | ------------- | -------------
**coordinateSequence** | **any** |  | [optional] [default to undefined]
**coordinates** | [**Array&lt;Coordinate3&gt;**](Coordinate3.md) |  | [optional] [default to undefined]
...
**centroid** | **any** |  | [optional] [default to undefined]
...
```typescript
import { Point2 } from './api';

const instance: Point2 = {
    coordinateSequence,
    coordinates,
    numPoints,
    isEmpty,
